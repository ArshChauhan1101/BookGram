...
import { Container, Books, Input, Fixed } from './styles';
...
import logo from '../../assets/bookgram.jpg';
    ...
    <Container>
      <Fixed>
        <h1 onClick={handleTitleClick}>
          BookGram <img src={Search} alt="Magnifying glass" />
        </h1>
        <p>
          Find world-class books with ease by searching for their author, title
          or publisher
        </p>
        <Input>
          <input
      ...
      <Books numberOfCards={booksFound?.length} books={!!booksFound?.length}>
        ...
        {booksFound?.length
          ...
          : loading ? (
              ...
              <img src={logo} alt="books" className="books" />
            )}
      </Books>
    </Container>
  );
